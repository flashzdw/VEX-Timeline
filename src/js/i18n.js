...
(function () {
  ...
  var DICT = {
    'zh-CN': {
      ...
      'auth.subtitle': '登录 · 注册',
      'auth.subtitle.login': '登录到你的账号',
      'auth.subtitle.register': '创建新账号',
      'auth.goRegister': '还没有账号？立即注册',
      'auth.goLogin': '已有账号？返回登录',
      ...
      'auth.realName.parent': '孩子的姓名',
      'auth.realName.parent.ph': '请输入孩子的真实姓名',
      'auth.realName.parent.hint': '系统会自动在后面添加"家长"',
      'auth.identity': '身份',
      'auth.identity.student': '学生',
      'auth.identity.teacher': '老师',
      'auth.identity.parent': '家长',
      ...
      'auth.nudge.title': '等一下！',
      'auth.nudge.body': '这几项对你在赛队里被认出很重要哦，真的不填一下吗？',
      'auth.nudge.ok': '好的，我去填',
      ...
      'auth.error.identityRequired': '请选择身份（学生/老师/家长）',
      'auth.error.realNameStudentTooShort': '学生姓名至少 2 个字符',
      'auth.error.realNameTeacherTooShort': '姓名至少 2 个字符',
      'auth.error.realNameParentTooShort': '孩子的姓名至少 2 个字符',
      'auth.error.realNameTeacherSurname': '仅填姓时，姓名必须是 1 个字符',
      ...
      'app.user.logout': '登出',
      'app.user.loggingOut': '登出中',
      'app.user.unlogged': '未登录',
      'app.user.unknown': '未知',
      'app.user.you': '你',
      'app.user.account': '账号',
      'app.user.settings': '个人设置',
      'app.user.basicInfo': '基本信息',
      'app.user.basicInfoSaved': '基本信息已更新',
      'app.user.saving': '保存中',
      'app.user.username': '用户名',
      'app.user.usernameHint': '修改后下次登录需用新用户名',
      'app.user.usernameInvalid': '用户名只能是 3-20 位字母/数字/_-',
      'app.user.usernameUnchanged': '用户名未变化',
      'app.user.usernameSaved': '用户名已更新，下次登录请用新用户名',
      'app.user.updating': '更新中',
      'app.user.changePassword': '更改密码',
      'app.user.oldPassword': '旧密码',
      'app.user.newPassword': '新密码',
      'app.user.confirmNewPassword': '确认新密码',
      'app.user.changingPassword': '更改密码中',
      'app.user.oldPasswordWrong': '旧密码错误',
      'app.user.passwordSaved': '密码已更新',
      'auth.error.passwordMismatch': '两次输入的新密码不一致',
      'auth.error.passwordUnchanged': '新密码不能与旧密码相同',
    ...
    'en': {
      ...
      'auth.goLogin': 'Already have an account? Sign in',
      ...
      'auth.realName.parent': "Child's name",
      'auth.realName.parent.ph': "Enter your child's real name",
      'auth.realName.parent.hint': 'The system will append "Parent" automatically',
      'auth.identity': 'Identity',
      'auth.identity.student': 'Student',
      'auth.identity.teacher': 'Teacher',
      'auth.identity.parent': 'Parent',
      ...
      'auth.nudge.title': 'Hold on!',
      'auth.nudge.body': 'These matter for being recognized in your team. Are you sure you don\'t want to fill them in?',
      'auth.nudge.ok': 'OK, I\'ll fill them in',
      ...
      'auth.error.identityRequired': 'Please choose an identity (student/teacher/parent)',
      'auth.error.realNameStudentTooShort': 'Student name must be at least 2 characters',
      'auth.error.realNameTeacherTooShort': 'Name must be at least 2 characters',
      'auth.error.realNameParentTooShort': "Child's name must be at least 2 characters",
      ...
      'app.user.loggingOut': 'Signing out',
      'app.user.unlogged': 'Not signed in',
      'app.user.unknown': 'Unknown',
      'app.user.you': 'You',
      'app.user.account': 'Account',
      'app.user.settings': 'Settings',
      'app.user.basicInfo': 'Basic info',
      'app.user.basicInfoSaved': 'Basic info updated',
      'app.user.saving': 'Saving',
      'app.user.username': 'Username',
      'app.user.usernameHint': 'After change, sign in with the new username next time',
      'app.user.usernameInvalid': 'Username must be 3-20 chars of letters/digits/_-',
      'app.user.usernameUnchanged': 'Username unchanged',
      'app.user.usernameSaved': 'Username updated, please use the new one next time',
      'app.user.updating': 'Updating',
      'app.user.changePassword': 'Change password',
      'app.user.oldPassword': 'Current password',
      'app.user.newPassword': 'New password',
      'app.user.confirmNewPassword': 'Confirm new password',
      'app.user.changingPassword': 'Changing password',
      'app.user.oldPasswordWrong': 'Wrong old password',
      'app.user.passwordSaved': 'Password updated',
      'auth.error.passwordMismatch': 'The two new passwords do not match',
      'auth.error.passwordUnchanged': 'The new password must be different from the old one',
